...
public class SenseSettings extends PreferenceActivity {
	...
	private void loadPreferences() {
		...
		try {
			...
			editor.putBoolean(PhoneState.CALL_STATE,
					service.getPrefBool(PhoneState.CALL_STATE, true));
			...
			editor.putBoolean(PhoneState.IP_ADDRESS,
					service.getPrefBool(PhoneState.IP_ADDRESS, true));
			editor.putBoolean(PhoneState.UNREAD_MSG,
					service.getPrefBool(PhoneState.UNREAD_MSG, true));
			...
			editor.putBoolean(Ambience.CAMERA_LIGHT,
					service.getPrefBool(Ambience.CAMERA_LIGHT, true));
