...
public class TagSensorRegistrator extends SensorRegistrator {
    ...
    public TagSensorRegistrator(Context context, String name, String displayName, String description, String dataType) {
        super(context);
        mName = name;
    ...
    public boolean verifySensorIds(String deviceType, String deviceUuid) {
        // verify existence of this tag sensor
        return checkSensor(mName, mDisplayName, mDataType, mDescription, mDataType, null, null);
    }
